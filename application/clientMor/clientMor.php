...
<body>
    ...
    <?php $sql = "SELECT COUNT(*) FROM affaire WHERE id_ClMor='" . $_SESSION['id'] . "'";
    $resultat = mysqli_query($conn, $sql);
    if ($resultat) {
    $row = mysqli_fetch_array($resultat);
    }
$sql1="SELECT COUNT(*) FROM affaire WHERE id_ClMor='" . $_SESSION['id'] . "' AND date_fin=NULL";
$res = mysqli_query($conn, $sql);
if ($res ) {
    $row1= mysqli_fetch_array($res);
}
$sql2="SELECT COUNT(*) 
FROM consultation INNER JOIN affaire ON consultation.id_aff=affaire.id_aff where id_ClMor='" . $_SESSION['id'] . "'
";
...
// FROM consultation 
// INNER JOIN client_mor ON consultation.id_ClMor = client_mor.id_ClMor 
// INNER JOIN affaire ON client_mor.id_ClMor  = affaire.id_ClMor  
// INNER JOIN avocat ON affaire.id_cin = avocat.id_cin  WHERE YEAR(dateCons)='$annee' AND  MONTH(dateCons) = '$mois' AND client_mor.id_ClMor ='" . $_SESSION['id'] . "'
...
if ($res && $res->num_rows > 0) {
   ...
   ?>
        ...
        <div class="col-div-4-1">
            <div class="box-1">
                <div class="content-box-1">
                    <p class="head-1">Nos intervenants <a href="intervClMor.php"><span class="voir-tout">Voir tout</span><a></p>
                    <?php 
                    ...
                    <form action="" method="POST">
                        ...
                        {  
                            ...
                            if(isset($_POST['nomInter'])&& isset($_POST['prenomInter'])&& isset($_POST['affaire']))
                            {
                               ...
                               $sql22="SELECT * from affaire where id_aff='$affaire'AND id_ClMor='" . $_SESSION['id'] . "'";
                               ...
                               if($res22 && $res22->num_rows>0)
                               {
                                ...
                                {     
                                    $row10 = $res10->fetch_assoc();
                                        ...
                                        SET  id_cin_ex='$row10[id_cin_ex]' WHERE  id_aff='$affaire ' AND id_ClMor='" . $_SESSION['id'] . "' ";
                               ...
                               else if($res20 && $res20->num_rows>0)
                                {
                                    $row20 = $res20->fetch_assoc();
                                        ...
                                        SET  id_cin_hn='$row20[id_cin_hn]' WHERE  id_aff='$affaire ' AND id_ClMor='" . $_SESSION['id'] . "'";
            ...
            <div class="box-1">
                ...
                if(isset($_POST['demCons'])){
                    if(isset($_POST['demDate'])&& (isset($_POST['demHeure']))&&  isset($_POST['affaire']))
                  {
                    ...
                    $sql8 = "SELECT * FROM affaire WHERE id_ClMor='" . $_SESSION['id'] . "' and id_aff=$affaire";
    ...
    <div class="col-div-12" style="	width: 80%; float:left; border-radius: 10px;">
        <div class="box-8" style="width: 97.8%; margin-left:315px; background-color: #fff; height: auto; border-radius: 10px;">
            <div class="content-box">
                <p class="head-1">Consultations de ce mois <a href="consultationsClMor.php"><span class="voir-tout">Voir tout</span><a> </p>
                <br />
                <?php 
                $mois= date('m');
                $annee=date('Y');
                ...
                AND client_mor.id_ClMor='" . $_SESSION['id'] . "'
                GROUP BY consultation.id_cons";
