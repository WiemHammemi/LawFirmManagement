   ...
   <a href="logout.php" class="logoutBtn" id="logoutBtn"><p><i class="fa fa-power-off"></i>&nbsp;&nbsp; Déconnexion</p></a>
        ...
        <div class="content">
                ...
                <?php if ($res && $res->num_rows > 0) {
                  ...
                  echo" <table  >
                <tr> <td>Nom </td> <td>".$row['nomClMor']."</td></tr>
                <td>Secteur</td><td>".$row['secteur']."</td> </tr>
               
              
                <td>Adresse</td> <td>".$row['adresseClMor']."</td> </tr>
                 
                <td>Numéro de télephone</td><td>".$row['num_telClMor']."</td> </tr>
                
                 <td>E-mail</td>  <td>".$row['emailClMor']."</td></tr>
                       </table>";
                    }
