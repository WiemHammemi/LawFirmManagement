...
<?php 
        ...
        INNER JOIN houss_not ON affaire.id_cin_hn=houss_not.id_cin_hn  
         ...
         <tr> <th>Numéro d'affaire  </th> <th>Date début </th> <th>Date fin </th><th>Client </th> <th>Huissier Notaire</th> <th>Expert </th><th>Commission </th><th> documents ajouté par votre client</th><th> Documents ajoutés par vous</th> <th>Ajouter un doc</th></tr>";
         if($res4)
         {
               ...
               $comm="-";
                ...
                echo"<tr>
                       <td>".$row1['id_aff']."</td>
                        ...
                        <td> <form method="POST" action="affairesChefAvocat.php" enctype="multipart/form-data">
        ...
        WHERE confirmHN='oui' 
         ...
         <tr> <th>Code d'affaire  </th> <th>Date début </th> <th>Date fin </th><th>Client </th> <th>Huissier Notaire</th> <th>Expert </th><th>Commission </th><th>Documents ajoutés par votre client</th> <th>Documents ajoutés par vous </th><th>ajouter un document </th></tr>";
         if($res8)
         {
