   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
        ...
        <div class="content">
                ...
                <br />
        <?php 
        $sql1="SELECT seance_trib.date_seance, seance_trib.heure_seance, tribunal.nomT, tribunal.zone, client_phy.nomClphy,client_phy.prenomClphy, seance_trib.id_aff 
        FROM seance_trib 
        ...
        GROUP BY seance_trib.id_seance ";
        $res1=$conn->query($sql1);
        if ($res1 && $res1->num_rows>0) {
            echo" <table  >
            <tr> <th>Date</th> <th>Heure</th><th>Affaire</th><th>Client</th><th>Tribunal</th><th>Zone du tribunal</th> </tr>";
...
<td>-</td>
<td>-</td> </tr>";
$sql2="SELECT seance_trib.date_seance, seance_trib.heure_seance, tribunal.nomT, tribunal.zone, client_mor.nomClMor, seance_trib.id_aff 
        FROM seance_trib 
        INNER JOIN tribunal ON seance_trib.id_trib = tribunal.id_trib 
        INNER JOIN affaire ON seance_trib.id_aff = affaire.id_aff 
    ...
    echo "</table>";
} else echo" <table class='table-inter' >
<tr> <th>Date</th> <th>Heure</th><th>Affaire</th><th>Client</th><th>Tribunal</th><th>Zone du tribunal</th> </tr>
<tr> <td>-</td>
<td>-</td>
<td>-</td>
...
<td>-</td> </tr>";
 ?>
        ...
        <p class="head-1">Ajout une séeance au tribunal</p>
                <br />
                <a href="ajoutseancetrib.php" style="text-decoration:none;"><span  style=" background-color:#8f6118f6;
  border-radius: 5px;
    color: white;
    padding: 10px 10px;
    margin-left:750px;
    font-size: 15px;">Ajouter une séance au tribunal</span></a> 
