   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
        ...
        <div class="content">
                ...
                <br />
                <?php        
        $sql="SELECT * FROM avocat where id_cin='" . $_SESSION['id'] . "'";
        $res=$conn->query($sql);
                 ...
                 if ($res && $res->num_rows > 0) {
                  ...
                  echo" <table  >
                <tr> <td>Nom </td> <td>".$row['nomA']."</td></tr>
                <td>Prenom </td>  <td>".$row['prenomA']."</td> </tr>
                <td>Spécialité</td><td>".$row['specialiteA']."</td></tr>
                <td>CV</td><td>".$row['cv']."</td></tr>
                <td>Adresse</td> <td>".$row['adresseA']."</td> </tr>
                 <td>Numéro de CIN</td>  <td>".$row['id_cin']."</td> </tr>
                <td>Numéro de télephone</td><td>".$row['num_telA']."</td> </tr>
                
                 <td>E-mail</td>  <td>".$row['emailA']."</td></tr>
                       </table>";
                    }
