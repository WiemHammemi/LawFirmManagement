...
if ($res && $res->num_rows > 0) {
   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
        ...
        <div class="content">
        <p class="head-1">Aouter affaire</p>
                <br />
...
<input type="text" id="desc" name="desc" required placeholder="Description de l'affaire"><br><br>
            ...
            if(isset($_POST['cin'])&& isset($_POST['datedeb']))
            {
               ...
               // $cinhn = isset($_POST['cinhn']) ? $_POST['cinhn'] : '';
                ...
                {   
                    ...
                    $sql1="INSERT into affaire (id_cin,id_cin_clphy,commission,date_dep,confirmHN,confirmEx,descrip) values ('" . $_SESSION['id'] . "','$cin','$comm','$datedeb','non','non','$d1')";
