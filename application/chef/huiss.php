...
<input type="text" id="nomhuis" name="nomhuis" required placeholder="Nom du huissier notaire" ><br><br>
<input type="text" id="prenomhuis" name="prenomhuis" required placeholder="Prenom du huissier notaire" ><br><br>

<input type="text" onfocus="(this.type='text')" onblur="(this.type='text')" name="telhuiss" id="telhuiss" required placeholder= "Numéro de tel"><br><br>

<input type="text" onfocus="(this.type='text')" onblur="(this.type='text')" name="mailhuiss" id="mailhuis" required placeholder= "E-mail"><br><br>

<input type="submit" name="ajouthuis" value="Ajouter">
</form>
        ...
        <br />
        <?php 
        if(isset($_POST['ajouthuis']))
        {
            if(isset($_POST['idcin'])&& isset($_POST['nomhuis']) && isset($_POST['prenomhuis']) && isset($_POST['telhuiss']) && isset($_POST['mailhuiss']))
            { 
                $id=$_POST['idcin'];
                $nom=$_POST['nomhuis'];
               $prenom=$_POST['prenomhuis'] ;
              $mail=$_POST['mailhuiss'] ;
                    $tel= $_POST['telhuiss'] ;
            }
                    $sql1="INSERT into houss_not (id_cin_hn,nomHN,prenomHN,tel_HN ,email_HN) values ($id, '$nom','$prenom','$tel','$mail')";
                    $res1=$conn->query($sql1);
                    if($res1)
                    {  
                        echo "<script>
                        window.onload = function(){alert('Huissier notaire ajouté avec succès.')}</script>";
