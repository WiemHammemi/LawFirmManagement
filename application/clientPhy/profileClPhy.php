    ...
    notiDiv.addEventListener('click', function() {
        ...
        <div class="content">
                ...
                <?php if ($res && $res->num_rows > 0) {
                  ...
                  echo" <table  >
                <tr> <td>Nom </td> <td>".$row['nomClphy']."</td></tr>
                <td>Prenom </td>  <td>".$row['prenomClphy']."</td> </tr>
                <td>Sexe </td> <td>".$row['sexe']."</td></tr>
                <td>Date de Naissance</td><td>".$row['date_naiss']."</td></tr>
                <td>Profession </td><td>".$row['profession']."</td> </tr>
                <td>Adresse</td> <td>".$row['adresse_Clphy']."</td> </tr>
                 <td>Numéro de CIN</td>  <td>".$row['id_cin_clphy']."</td> </tr>
                <td>Numéro de télephone</td><td>".$row['num_telClphy']."</td> </tr>
                
                 <td>E-mail</td>  <td>".$row['emailClphy']."</td></tr>
                       </table>";
                    }
