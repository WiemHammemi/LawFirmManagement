...
if ($res && $res->num_rows > 0) {
   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
        ...
        WHERE affaire.id_cin_clphy='" . $_SESSION['id'] . "'
     ...
     <div class="col-div-12">
        <div class="box-8">
            <div class="content-box">
                ...
                FROM consultation 
                INNER JOIN client_phy ON consultation.id_cin_clphy = client_phy.id_cin_clphy 
        ...
        WHERE  Year(date_seance)='$annee' 
                AND  MONTH(date_seance) = '$mois' AND affaire.id_cin_clphy='" . $_SESSION['id'] . "'
