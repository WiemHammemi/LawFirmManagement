    ...
    notiDiv.addEventListener('click', function() {
        ...
        <p class="head-1">Votre affaires</p>
            ...
            AND affaire.confirmHN='non'
             ...
             AND  affaire.id_cin_clphy='" . $_SESSION['id'] . "'  
             
             GROUP BY affaire.id_aff";
               
            $sql2="  SELECT affaire.id_aff , affaire.date_fin, affaire.date_dep , affaire.id_aff,affaire.commission , avocat.nomA, avocat.prenomA ,houss_not.nomHN,houss_not.prenomHN
               FROM affaire 
               INNER JOIN avocat ON affaire.id_cin=avocat.id_cin
            ...
            $sql3="  SELECT affaire.id_aff , affaire.date_fin, affaire.date_dep , affaire.id_aff,affaire.commission , avocat.nomA, avocat.prenomA  
            FROM affaire 
            INNER JOIN avocat ON affaire.id_cin=avocat.id_cin
            ...
            INNER JOIN houss_not ON affaire.id_cin_hn=houss_not.id_cin_hn  
             ...
             echo" <table >
             <tr> <th>Code </th> <th>Date début </th> <th>Date fin </th><th>Avocat </th> <th>Huissier Notaire</th> <th>Expert </th><th>Commission </th> <th> Documents ajoutés par vous </th><th> Documents ajoutés par votre avocat</th><th>Importer </th></tr>";
             if($res1)
            {
                ...
                echo"<tr>
                       <td>".$row1['id_aff']."</td>
                        ...
                        <td>".$comm.'  </td>
                         ...
                         <td> <form method="POST" action="affaireClPhy.php" enctype="multipart/form-data">
