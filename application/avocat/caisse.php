...
if ($res && $res->num_rows > 0) {
   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
       ...
       $sql1="SELECT consultation.id_cons ,consultation.dateCons, consultation.heure, client_phy.id_cin_clphy , client_phy.nomClphy,client_phy.prenomClphy, affaire.id_aff, affaire.id_cin
        FROM consultation 
       ...
       $sql2="SELECT consultation.id_cons ,consultation.dateCons, consultation.heure,client_mor.id_ClMor , client_mor.nomClMor, affaire.id_aff, affaire.id_cin
        FROM consultation 
        INNER JOIN affaire ON consultation.id_aff=affaire.id_aff
