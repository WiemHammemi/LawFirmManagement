...
if ($res && $res->num_rows > 0) {
   ...
   ?>
    ...
    notiDiv.addEventListener('click', function() {
       ...
       $sql1="SELECT consultation.id_cons,consultation.pv,consultation.dateCons, consultation.heure, client_phy.id_cin_clphy , client_phy.nomClphy,client_phy.prenomClphy, affaire.id_aff, affaire.id_cin
       FROM consultation 
       ...
       WHERE confirm='oui' AND affaire.id_cin='" . $_SESSION['id'] . "' 
       GROUP BY id_cons ";
      $res1=$conn->query($sql1);
      $sql2="SELECT consultation.id_cons ,consultation.pv,consultation.dateCons, consultation.heure,client_mor.id_ClMor , client_mor.nomClMor, affaire.id_aff, affaire.id_cin
       FROM consultation 
       INNER JOIN affaire ON consultation.id_aff=affaire.id_aff
      ...
      $res2=$conn->query($sql2);
        ?>
        <div class="content">
                <p class="head-1">Votre consultations</p>
                <div class="clearfix"></div>
                <br />
                <div class="tableau">
                <?php 
                if ($res1 && $res1->num_rows > 0) {
                  echo" <table  >
                <tr> <th>Client </th> <th>Date </th><th>Heure </th> <th>Affaire </th> <th>PV </th></tr>";
