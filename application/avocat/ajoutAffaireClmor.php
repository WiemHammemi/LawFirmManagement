...
<input type="submit" name="ajoutAff" value="Ajouter">
        ...
        {
            if(isset($_POST['id'])&& isset($_POST['datedeb']))
            {
                $id=$_POST['id'];
               ...
               // $cinhn = isset($_POST['cinhn']) ? $_POST['cinhn'] : '';
                ...
                $d1=mysqli_real_escape_string($conn,$descrip) ;
                    ...
                    if($res&& $res->num_rows>0)
                {
                    ...
                    $sql1="INSERT into affaire (id_cin,id_ClMor,commission,date_dep,confirmHN,confirmEx,descrip) values ('" . $_SESSION['id'] . "','$id','$comm','$datedeb','non','non','$d1')";
