...
if ($res && $res->num_rows > 0) {
 ...
 ;				}
  ...
  ;				}
	...
	<div class="box-1">
	<div class="content-box-1">
			<p class="head-1">Nos Intervenants<a href="IntervAvocat.php"><span class="voir-tout">Voir tout</span><a> </p>
			<?php 
	...
	<div class="col-div-4-1">
		<div class="box-1" style="overflow-y:scroll;">
			<div class="content-box-1" >
			<p class="head-1">Consultation de ce mois<a href="consultationsAvocat.php"><span class="voir-tout">Voir tout</span><a> </p>
			<br/>
